...
In addition to the link:trident-install/kubernetes-deploy.html#before-you-begin[deployment prerequisites] you need link:https://v3.helm.sh/[Helm version 3^].
